...
import com.easyweather.app.db.EasyWeatherOpenHelper;
...
public class EasyWeatherDB {
    ...
    private EasyWeatherDB(Context context){
        EasyWeatherOpenHelper dbHelper = new EasyWeatherOpenHelper(context,
     ...
     * 获取EasyWeatherDB实例
     */
    public synchronized static EasyWeatherDB geteInstance(Context context){
